...
dialogModule.controller("MessageBoxController", ["$scope", "dialog", "model", function (t, e, n) {
    ...
    }]), angular.module("ui.bootstrap.pagination", []).constant("paginationConfig", {boundaryLinks: !1, directionLinks: !0, firstText: "First", previousText: "Prev", nextText: "Next", lastText: "Last"}).directive("pagination", ["paginationConfig", function (t) {
        return{restrict: "EA", scope: {numPages: "=", currentPage: "=", maxSize: "=", onSelectPage: "&", totalItems:"=", numPerPage:"="}, templateUrl: "template/pagination/pagination.html", replace: !0, link: function (e, n, o) {
                function a(t, e, n, o) {
                ...
                e.$watch("numPages + currentPage + maxSize + totalItems + numPerPage", function () {
                    e.pages = [];
                    e.totalItems = (e.totalItems)?e.totalItems:0;
                    //For showinf record setting in pagination left section
                    var fromNo = 0;
                    var endNo = 0;
                    if(e.currentPage == 1){
                        fromNo = e.currentPage;
                        if(e.currentPage == e.numPages){
                            endNo = e.totalItems;
                        }else{
                            endNo = e.numPerPage;
                        }                        
                    }else{
                        fromNo = ((e.currentPage-1) * e.numPerPage) + 1;
                        if(e.currentPage == e.numPages){
                            endNo = e.totalItems;
                        }else{
                            endNo = (e.currentPage * (e.numPerPage));
                        }
                    }
                    if(e.totalItems == 1){
                        recordtect = "Record";
                    ...
                    if(e.totalItems == 0){
                        ...
                        var showingtext = "Showing "+fromNo+" to "+endNo+" of "+e.totalItems+" "+recordtect;
                    }
                    e.pagedata = {'totalpages':e.numPages,'showingtext':showingtext};
                        ...
                        function v() {
                            ...
                            if (t.tt_content) {
                                switch ($ && r.cancel($), C.css( {
                                        top: 0, left: 0, display: "block"}), f.appendToBody ? (k = k || s.find("body"), k.append(C)) : e.after(C), n = c.position(e), o = C.prop("offsetWidth"), a = C.prop("offsetHeight"), t.tt_placement){case"right":
                        ...
                        if (t === u.$viewValue) {
                            if (n.length > 0) {
                                ...
                                for (var o = 0; n.length > o; o++)
                                    e[f.itemName] = n[o], v.matches.push({label: f.viewMapper(v, e), model: n[o]});
    ...
    return function (e, n) {
        ...
        t.put("template/pagination/pagination.html", '<div class="pagination"><div class="showingdiv"><label>{{pagedata.showingtext}}</label></div><ul ng-show="pagedata.totalpages > 1">\n  <li ng-repeat="page in pages" ng-class="{active: page.active, disabled: page.disabled}" ng-hide="page.disabled"><a ng-click="selectPage(page.number)">{{page.text}}</a></li>\n  </ul>\n</div>\n')
